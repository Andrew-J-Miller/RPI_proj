...
namespace WindowsFormsApp2
{
    ...
    public Form1()
        ...
        private void run_cooling()
        {
            ...
            start3.FileName = "/usr/bin/python3";
            start3.Arguments = string.Format("{0} {1} {2}", "CoolScript.py", NumberOfDegree.Text, FahrenheitRadio.Checked);
            start3.UseShellExecute = false;
            start3.RedirectStandardOutput = true;
            using (Process process = Process.Start(start3))
            {
        ...
        private void run_boiling()
        {
            ...
            start.Arguments = string.Format("{0} {1} {2}", "BoilScript.py", NumberOfDegree.Text, FahrenheitRadio.Checked);
        ...
        private void run_mashing()
        {
            ...
            start1.FileName = "/usr/bin/python3";
            start1.Arguments = string.Format("{0} {1} {2}", "MashScript.py", NumberOfDegree.Text, FahrenheitRadio.Checked);
        ...
        private void run_current_temperature()
        {
            ...
            start2.FileName = "/usr/bin/python3";
            start2.Arguments = string.Format("{0} {1} {2}", "HeaterTemplate.py", NumberOfDegree.Text, FahrenheitRadio.Checked);
